...
var Chat = require('../models/ChatModel').ChatModel;
var Message = require('../models/MessageModel').MessageModel;
var Sticker = require('../models/StickerModel').StickerModel;
var User = require('../models/UserModel').UserModel;
var JoinedUser = require('../models/JoinedUserModel').JoinedUserModel;
module.exports = {
